 ...
 * @LastEditTime: 2021-09-02 15:58:07
...
-->
<template>
  <div class="pg-photo-layer draggable-source"
    ...
    <div v-if="bleed.borderWidth"
         :style="bleedVal"
         class="bleed"></div>
    <div v-if="layer.data && !layer.data.valid"
         class="layer-warning-icon">
      <!-- <tooltip
        :content="
...
export default {
  ...
  computed: {
    ...
    layerId() {
      return this.layoutId + '&' + this.layer.id;
    }
  }
};
</script>
