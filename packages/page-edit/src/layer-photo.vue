 ...
 * @LastEditTime: 2021-06-23 11:18:12
...
export default {
  ...
  computed: {
    layerId() {
      const { pageId, lIndex, layer } = this;
      return `${pageId}&${lIndex}&${layer.id}`;
    }
  }
};
</script>